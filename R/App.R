...
runElementR <- function(){
  ...
  server <- function(input, output, session) {  
    ...
    observe({
      if(flagStart$temp[1] == 3 | flagStart$temp[2] == 3){
        output$Export <-  renderUI({actionButton("export","Export Project")}) 
      }else{
      ...
      if(!is.null(input$ExportGraph)){      
        if(input$ExportGraph > 0){
          isolate({
            ...
            if(is.null(length(input$courveToExport))){}
            if(is.null(length(input$ElementToExport))){}
            else{
              pb <- tkProgressBar("Progress bar", "Graphic export in %",
                                  0, 100, 0)
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("RowData_",temporaire ,".jpg"), width = 480, height = 400)
              } else {
                
                if(input$exportFormat == ".jpeg"){
                  jpeg(filename = paste0("RowData_",temporaire ,".jpg"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".bpm"){
                  bmp(filename = paste0("RowData_",temporaire ,".bmp"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".png"){
                  png(filename = paste0("RowData_",temporaire ,".png"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".tiff"){
                  tiff(filename = paste0("RowData_",temporaire ,".tiff"), width = input$exportwidth, height = input$exportheight)
                } else {}
              }
              ...
              if(length(grep(input$standardIn, currentProject()$standardsFiles)) != 0){
                ...
                lapply(2:length(input$ElementToExport), function(x){
                ...
                if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 0){
                  Temp0$t <- currentProject()$closest(x = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[,1],y = input$bins)[[2]]
                  ...
                  Temp0$t <- currentProject()$closest(x = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[,1], y  = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$bins)[[2]]
                ...
                rect(-maxX,-maxY,currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[Temp0$t,1],(1+10/100)*maxY, col = "#8B735564", border = NA)
              ...
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("RowData_All_graph",i,".jpg"), width = 480, height = 400)
                } else{
                  
                  if(input$exportFormat == ".jpeg"){
                    jpeg(filename = paste0("RowData_All_graph",i,".jpg"), width = input$exportwidth, height = input$exportheight)
                  } else {}
                  
                  if(input$exportFormat == ".bmp"){
                    bmp(filename = paste0("RowData_All_graph",i,".bmp"), width = input$exportwidth, height = input$exportheight)
                  } else {}
                  
                  if(input$exportFormat == ".png"){
                    png(filename = paste0("RowData_All_graph",i,".png"), width = input$exportwidth, height = input$exportheight)
                  } else {}
                  
                  if(input$exportFormat == ".tiff"){
                    tiff(filename = paste0("RowData_All_graph",i,".tiff"), width = input$exportwidth, height = input$exportheight)
                  } else {}
                }
                ...
                for(j in (6*(i-1)+1):(6*i)){
                  ...
                  if(!is.null(input$bins) & !is.null(input$plat)){
                    if(is.na(input$bins) | is.na(input$plat[1]) | is.na(input$plat[2])){
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("RowData_All_graph",nbGraph+1,".jpg"), width = 480, height = 400)
              } else {
                if(input$exportFormat == ".jpeg"){
                  jpeg(filename = paste0("RowData_All_graph",nbGraph+1,".jpg"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".bmp"){
                  bmp(filename = paste0("RowData_All_graph",nbGraph+1,".bmp"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".png"){
                  png(filename = paste0("RowData_All_graph",nbGraph+1,".png"), width = input$exportwidth, height = input$exportheight)
                } else {}
                
                if(input$exportFormat == ".tiff"){
                  tiff(filename = paste0("RowData_All_graph",nbGraph+1,".tiff"), width = input$exportwidth, height = input$exportheight)
                } else {}
              } 
              ...
              for(i in 1: length(input$ElementToExport)){
                for(j in 1: length(input$courveToExport)){ 
                  ...
                  if(is.null(input$exportFormat)){
                    jpeg(filename = paste0("FilteredData",input$courveToExport[j],".jpg"), width = 480, height = 400)
                  } else { 
                    
                    if(input$exportFormat == ".jpeg"){
                      jpeg(filename = paste0("FilteredData",input$courveToExport[j],".jpg"), width = input$exportwidth, height = input$exportheight)
                    } else {}
                    
                    if(input$exportFormat == ".bmp"){
                      bmp(filename = paste0("FilteredData",input$courveToExport[j],".bmp"), width = input$exportwidth, height = input$exportheight)
                    } else {}
                    
                    if(input$exportFormat == ".png"){
                      png(filename = paste0("FilteredData",input$courveToExport[j],".png"), width = input$exportwidth, height = input$exportheight)
                    } else {}
                    
                    if(input$exportFormat == ".tiff"){
                      tiff(filename = paste0("FilteredData",input$courveToExport[j],".tiff"), width = input$exportwidth, height = input$exportheight)
                    } else {}
                  }
                  ...
                  if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 0){
                    if(is.null(input$bins)){                  
                      ...
                      if(is.finite(Temp0$t)){
                        curve <- currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$getData(curve = input$courveToExport[j], bins = Temp0$t, plat = c(Temp1$t,Temp2$t), rempl = input$valRemplace)
                      } else {}
                    }
                  } else if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 1){
              ...
              for(i in 1: length(input$ElementToExport)){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("FilteredData_All.jpg"), width = 480, height = 400)
                } else {
                  if(input$exportFormat == ".jpeg"){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("FilteredData_All2.jpg"), width = 480, height = 400)
                } else{
                  if(input$exportFormat == ".jpeg"){
                ...
                if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 0){
                  if(is.null(input$bins)){
                    ...
                    if(is.finite(Temp0$t)){
                      curve <- currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$getData(curve = input$courveToExport[length(input$courveToExport)], bins = Temp0$t, plat = c(Temp1$t,Temp2$t), rempl = input$valRemplace)
                    } else {}
                  }
                } else if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 1){
                ...
                par(mar = c(3.5,3.7,1.75,1))
                plot(curve[,1], curve[,grep(input$ElementToExport[length(input$courveToExport)], colnames(curve))],  type ="b", ylab = "", xlab = "", main = "") 
                mtext("Signal intensity (cps)",side=2,line=2.6,  cex=1.2)
                mtext("Time (s)",side=1,line=2.3, at=par("usr")[2]-0.05*diff(par("usr")[1:2]), cex=1.2)
      ...
      if(!is.null(input$ExportGraphS)){
        ...
        if(input$ExportGraphS > 0){
          isolate({
            ...
            if(!is.null(length(input$courveToExportS))){
              if(!is.null(length(input$ElementToExportS))){
                pb <- tkProgressBar("Progress bar", "Graphic export in %",
                                    0, 100, 0)
                ...
                if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) != 0){
                  ...
                  if(length(input$ElementToExportS) > 1){
                    lapply(2:length(input$ElementToExportS), function(x){
                      par(new = TRUE)
                  ...
                  Temp0S$t <- currentProject()$closest(x = currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$data[,1],y = input$binsSample)[[2]]
                  ...
                  rect(-maxX,-maxY,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$data[Temp0S$t,1],(1+10/100)*maxY, col = "#8B735564", border = NA)
                ...
                for(i in 1: length(input$ElementToExportS)){
                  for(j in 1: length(input$courveToExportS)){ 
                    ...
                    if(is.null(input$exportFormat)){
                      jpeg(filename = paste0("FilteredData",input$courveToExportS[j],".jpg"), width = 480, height = 400)
                    } else{
                      if(input$exportFormat == ".jpeg"){
                        jpeg(filename = paste0("FilteredData",input$courveToExportS[j],".jpg"), width = input$exportwidth, height = input$exportheight)
                      } else {}
                      
                      if(input$exportFormat == ".bmp"){
                        bmp(filename = paste0("FilteredData",input$courveToExportS[j],".bmp"), width = input$exportwidth, height = input$exportheight)
                      } else {}
                      
                      if(input$exportFormat == ".png"){
                        png(filename = paste0("FilteredData",input$courveToExportS[j],".png"), width = input$exportwidth, height = input$exportheight)
                      } else {}
                      
                      if(input$exportFormat == ".tiff"){
                        tiff(filename = paste0("FilteredData",input$courveToExportS[j],".tiff"), width = input$exportwidth, height = input$exportheight)
                      } else {}
                    }
                      ...
                      if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) == 0){
                        ...
                        if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 0){
                          if(is.null(input$bins)){                          
                            ...
                            if(is.finite(Temp0S$t)){
                              curveS <- currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$getData(curve = input$courveToExportS[j], bins = Temp0S$t, plat = c(Temp1S$t,Temp2S$t), name = input$SampleIn2, meanStand = currentProject()$standards[[1]]$rep_dataFinale[(nrow(currentProject()$standards[[1]]$rep_dataFinale)-1),], rank = currentProject()$sampleRank, model = currentProject()$regressionModel, calibFile = currentProject()$EtalonData, correction = currentProject()$machineCorrection, rempl = input$valRemplace)
                ...
                for(i in 1: length(input$ElementToExportS)){
                  ...
                  if(is.null(input$exportFormat)){
                    jpeg(filename = "FilteredData_All.jpg", width = 480, height = 400)
                  } else{
                    if(input$exportFormat == ".jpeg"){
                      jpeg(filename = "FilteredData_All.jpg", width = input$exportwidth, height = input$exportheight)
                    } else{}
                  ...
                  for(j in 1: (length(input$courveToExportS)-2)){                
                    ...
                    if(length(grep(input$SampleIn,currentProject()$samplesFiles)) != 0){
                      if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) == 0){
                        ...
                        if(is.null(input$bins)){                          
                          ...
                          if(is.finite(Temp0S$t)){curveS <- currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$getData(curve = input$courveToExportS[j], bins = Temp0S$t, plat = c(Temp1S$t,Temp2S$t), name = input$SampleIn2, meanStand = currentProject()$standards[[1]]$rep_dataFinale[(nrow(currentProject()$standards[[1]]$rep_dataFinale)-1),], rank = currentProject()$sampleRank, model = currentProject()$regressionModel, calibFile = currentProject()$EtalonData, correction = currentProject()$machineCorrection, rempl = input$valRemplace)
                          } else {}
                        }
                      } else if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 1){
                  ...
                  if(is.null(input$exportFormat)){
                    jpeg(filename = "FilteredData_All2.jpg", width = 480, height = 400)
                  }  else{                
                    if(input$exportFormat == ".jpeg"){
                      jpeg(filename = "FilteredData_All2.jpg", width = input$exportwidth, height = input$exportheight)
                    } else {}
                  ...
                  for(j in (length(input$courveToExportS)-1): (length(input$courveToExportS))){
                    ...
                    if(length(grep(input$SampleIn,currentProject()$samplesFiles)) != 0){
                      if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) == 0){                      
                        ...
                        if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 0){
                          ...
                          if(is.finite(Temp0S$t)){curveS <- currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$renderData(curve = input$courveToExportS[j])
                          }
                    ...
                    if(!is.null(curveS)){
                      if(length(which(!is.na(curveS[,grep(input$ElementToExportS[i], colnames(curveS))]))) == 0){
                        ...
                        par(mar = c(3.5,3.7,1.75,1))
                        plot(curveS[,1], curveS[,grep(input$ElementToExportS[j], colnames(curveS))],  type ="b", ylab = "", xlab = "", main = "") 
                        mtext("Signal intensity (cps)",side=2,line=2.6,  cex=1.2)
                        mtext("Time (s)",side=1,line=2.3, at=par("usr")[2]-0.05*diff(par("usr")[1:2]), cex=1.2)
                        mtext(paste("Data filtered",input$ElementToExportS[i], input$courveToExportS[j]),side=3,line=0.75, cex=1.2, font = 2)
                      }
          ...
          isolate({
            ...
            if(nbGraph > 0){
              ...
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("Machine_Drift_3_&_Sup",i,".jpg"), width = 480, height = 400)
                } else{
                  if(input$exportFormat == ".jpeg"){
            ...
            if(nRest != 0){
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("Machine_Drift_3_&_Sup",nbGraph + 1,".jpg"), width = 480, height = 400)
              } else {
                if(input$exportFormat == ".jpeg"){
            ...
            if(nbGraph > 0){
              ...
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("Machine_Drift_2",i,".jpg"), width = 480, height = 400)
                } else {
                  if(input$exportFormat == ".jpeg"){
            ...
            if(nRest != 0){
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("Machine_Drift_2",nbGraph + 1,".jpg"), width = 480, height = 400)
              } else{
                if(input$exportFormat == ".jpeg"){
            ...
            if(nbGraph > 0){
              ...
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("Machine_Drift_1",i,".jpg"), width = 480, height = 400)
                } else{
                  if(input$exportFormat == ".jpeg"){
            ...
            if(nRest != 0){
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("Machine_Drift_1",nbGraph + 1,".jpg"), width = 480, height = 400)
              } else{
                if(input$exportFormat == ".jpeg"){
            ...
            if(nbGraph > 0){
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("Machine_Drift_0",i,".jpg"), width = 480, height = 400)
                } else{
                  if(input$exportFormat == ".jpeg"){
            ...
            if(nRest != 0){
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("Machine_Drift_0",nbGraph + 1,".jpg"), width = 480, height = 400)
              } else{
                if(input$exportFormat == ".jpeg"){
      ...
      if(!is.null(input$RealignExportGraph)){
        ...
        if(input$RealignExportGraph>0){
          ...
          isolate({
            ...
            if(is.null(length(input$RealignElementToExport))){
                ...
                for(i in 1:length(input$RealignElementToExport)){
                  ...
                  if(length(which(!is.na(unlist(lapply(1:length(tabProvSample$temp), function(j){tabProvSample$temp[[j]][,input$RealignElementToExport[i]]}))))) == 0){
                    ...
                    lapply(1:length(input$ReplicateSample), function(x){
                      ...
                      plot(tabProvSample$temp[[which(names(generRRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])]][,1],tabProvSample$temp[[which(names(generRRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])]][,input$RealignElementToExport[i]] , xlim = xlim, ylim = ylim, xlab = "Time (s)", ylab = "Concentrations", type = "b", main = input$RealignElementToExport[i] , col = colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])] )
              ...
              for(i in 1: nbGraph){
                ...
                if(is.null(input$exportFormat)){
                  jpeg(filename = paste0("RealignData_",i ,".jpg"), width = 480, height = 400)
                }else{
                  if(input$exportFormat == ".jpeg"){
                ...
                for(y in (6*(i-1)+1):(6*i)){
                  ...
                  if(y == (6*(i-1)+1)){
                    ...
                    if((flagRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][2]%%4) == 0){
                      legend(0,1, legend = input$ReplicateSample, col = sapply(1:length(input$ReplicateSample), function(x){colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])]}), lty = c(1,1))
                    } else{                    
                      legend(0,1, legend = c(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster, "Averaging"), col = c(sapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[x])]}), "black"), lty = c(1,1))
                    }
                  } else{
                    if((flagRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][2]%%4) == 0){
                      ...
                      if(length(which(!is.na(unlist(lapply(1:length(tabProvSample$temp), function(x){tabProvSample$temp[[x]][,input$RealignElementToExport[y-i]]}))))) == 0){
                        ...
                        lapply(1:length(input$ReplicateSample), function(x){
                          ...
                          plot(tabProvSample$temp[[which(names(generRRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])]][,1],tabProvSample$temp[[which(names(generRRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])]][,input$RealignElementToExport[y-i]] , xlim = xlim, ylim = ylim, xlab = "Time (s)", ylab = "Concentrations", type = "b", main = input$RealignElementToExport[y-i] , col = colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == input$ReplicateSample[x])] )
                      ...
                      if(length(which(!is.na(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]]}))))) == 0){
                        plot(-1,-1, xlim = c(0,2), ylim = c(0,1),xlab = "", ylab = "")
                        text(1,0.5, labels = "No data different from NA for this element", cex = 2)
                      } else{
                        
                        ylim <- c(min(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]]})), na.rm = TRUE),max(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]]})), na.rm = TRUE))
                        
                        xlim <- c(min(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,1]}))),max(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,1]})), na.rm = TRUE))
                        
                        lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){ 
                          
                          plot(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,1],currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]] , xlim = xlim, ylim = ylim, xlab = "Time (s)", ylab = "Concentrations", main = input$RealignElementToExport[y-i] , type = "b", col =colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[x])] )
                          
                          par(new = TRUE)
                          
                        })
                        
                        plot(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataFinalRaster[,1],currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataFinalRaster[,input$RealignElementToExport[y-i]], xlim = xlim, ylim = ylim, xlab = "", ylab = "", type = "b")
              ...
              if(is.null(input$exportFormat)){
                jpeg(filename = paste0("RealignData_",nbGraph+1,".jpg"), width = 480, height = 400)
              } else{
                if(input$exportFormat == ".jpeg"){
              ...
              for(y in (6*nbGraph+1): (6*nbGraph + nRest)){
                  ...
                  if((flagRealign$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][2]%%4) == 0){
                    ...
                    if(length(which(!is.na(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]]}))))) == 0){
                      ...
                      lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){ 
                        ...
                        plot(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,1],currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$RealignElementToExport[y-i]] , main = input$RealignElementToExport[y-i] , xlim = xlim, ylim = ylim, xlab = "Time (s)", ylab = "Concentrations", type = "b", col =colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]][which(names(colorReplicate$temp[[grep(input$selectRealign,currentProject()$samplesFiles)]]) == currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[x])] )
    ...
    # upload a project already filtered and set color ans flags
    observe({
    ...
    observe({
      if(is.null(input$calibFile)){
        ...
        if(input$calibFile > 0){
          ...
          temp <- tk_choose.files(default = getwd(), caption = "Select files",
    ...
    observe({
        ...
        output$start1 <-  renderUI({
          fluidRow(
            box(
              ...
              width = 12,
              column(9,                       
                     div(h3(icon("cogs"),"Step 1. Choose to create a new project or load an existing one"), style = "display: inline-block;")
              )
            )
          )
        })
      ...
      if(flagStart$temp[1] == 3){
        ...
        output$start1 <- renderUI({
          fluidRow(
            box(
              ...
              column(3, 
                     br(),
                     actionButton("SuppDonne","Starting another project")
              ) 
            )
          )
        })
        ...
        output$start2 <- renderUI({    
          fluidRow(style="margin-left:0px;margin-right:0px",
                   box(
                     title = list(icon("folder-o"),"Your created project ..."),
                     width = 12,
                     status="primary",
                     solidHeader = TRUE,
                     p(icon("share "), projChar$temp[[2]]),
                     p(icon("share "), paste0("Name of the project: ", projChar$temp[[3]])),
                     p(icon("share "), paste0("Path of the project: ", projChar$temp[[4]])),
                     p(icon("share "), paste0("standard files within project: ", paste0(projChar$temp[[5]], collapse = " "))),
                     p(icon("share"), paste0("Sample files within project: ", paste0(projChar$temp[[6]], collapse = " "))),
                     p(icon("share"), paste0("Considered elements: ", paste0(currentProject()$listeElem, collapse = " ")))              
                   ),
                   box(
      ...
      if(flagStart$temp[2] == 3){      
        ...
        output$start2 <- renderUI({
          fluidRow(style="margin-left:0px;margin-right:0px",
                   box(
                     title = list(icon("folder-o"),"The project loaded ..."),
                     width = 12,
                     status="primary",
                     solidHeader = TRUE,
                     p(icon("share"), projChar$temp[[2]]),
                     p(icon("share"), paste0("Name of the project: ", projChar$temp[[4]])),
                     p(icon("share"), paste0("Path of the project: ", projChar$temp[[3]])),
                     p(icon("share"), paste0("standard files within project: ", paste0(projChar$temp[[6]], collapse = " "))),
                     p(icon("share"), paste0("Sample files within project: ", paste0(projChar$temp[[7]], collapse = " "))),
                     p(icon("share"), paste0("Considered elements: ", paste0(projChar$temp[[8]], collapse = " ")))
                   ),
                   box(
                     title = list(icon("folder-o"),"Important information"),
                     width = 12,
            ...
            fluidRow(
              box(
                ...
                column(5, class = "class3",
                       div(h3(icon("flask"),"Step 2. Filtering data from standards"), style = "display: inline-block;")
                ),
                ...
                output$Standards2 <- renderUI({
                  ...
                  fluidRow(
                    column(8, style  = "padding-right: 5px"  ,                       
                           box(
                             title = list(icon("share"),"Background and plateau threshold selection"),
                             status="success",
                             solidHeader = TRUE,
                             width = "100%", 
                             height = "640px",
                ...
                output$distPlot <- renderPlot({
                  ...
                  if(length(grep(input$standardIn, currentProject()$standardsFiles)) == 0){
                    ...
                    if(is.null(input$checkGroup)){
                      ...
                      rect(-maxX,-maxY,currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$bins,(1+10/100)*maxY, col = "#8B735564", border = NA)
                      ...
                      abline(v = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$bins, lty = "dashed", col = "grey", lwd = 2)
        ...
        if(length(which(as.matrix(currentProject()$standardsFiles) == input$standardIn)) == 0){        
          ...
          if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] %%2) == 0){          
            if(is.null(input$bins)){            
              ...
              if(is.finite(Temp0$t)){dataPlot2$dat <- currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$getData(curve = input$CourbeNIST, bins = Temp0$t, plat = c(Temp1$t,Temp2$t), rempl = input$valRemplace)
    ...
    observe({
      if(is.null(currentProject())){      
        ...
        if(length(which(as.matrix(currentProject()$standardsFiles) == input$standardIn)) != 0){
              ...
              if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)]%%2) == 0 & input$saveNists > 0 & flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)] != 0){
                isolate({
                  currentProject()$setflagMachineCorrection(x = 0)  
                  ...
                  flagRealign$temp <- currentProject()$flagRealign 
                  validCorrection$temp <- currentProject()$flagMachineCorrection 
                  currentProject()$set_summarySettings(name = input$standardIn, rank = NA, bins = NA, plat1 = NA, plat2 = NA, average = NA, LOD = NA)
                })

                
              }  else {}
              if((flagStandard$temp[which(as.matrix(currentProject()$standardsFiles) == input$standardIn)]%%2) == 1 & is.finite(Temp0$t) & input$saveNists > 0 ){
                isolate({
                  currentProject()$setflagStand (place = which(as.matrix(currentProject()$standardsFiles) == input$standardIn),value = 1)
                  currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$setBins(bins = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[Temp0$t,1])     
                  ...
                  currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$setDataOutlierFree(bins = Temp0$t, plat = c(Temp1$t,Temp2$t), rempl = input$valRemplace)
                  currentProject()$set_summarySettings(name = input$standardIn, rank = currentProject()$standardRank[which(names(currentProject()$standardRank) == input$standardIn)], bins = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[Temp0$t,1], plat1 = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[Temp1$t,1], plat2 = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$data[Temp2$t,1], average = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$BlankAverarge, LOD = currentProject()$standards[[1]]$rep_data[[grep(input$standardIn, currentProject()$standardsFiles)]]$LOD)
          ...
          output$MachDrift3_1 <- renderUI({
            ...
            lapply(one$temp, function(x){
              ...
              output[[plotname2]] <- renderPlot({
                ...
                currentProject()$PlotIC(name = currentProject()$standardsFiles, Mean = currentProject()$standards[[1]]$rep_dataFinale[1:length(currentProject()$flag_stand),x], SD = currentProject()$standards[[1]]$rep_dataFinale[(length(currentProject()$flag_stand)+1):(2*length(currentProject()$flag_stand)),x], coord = coord$temp, lengthSeg = 0.1, xlim =c(min(coord$temp),max(coord$temp)), ylim=c(min, max),ylab = paste0("Cps_",currentProject()$listeElem[x],"/Cps_Ca"),xlab = "")
          ...
          output$MachDrift3_2 <- renderUI({
            ...
            lapply(two$temp, function(x){
              ...
              box(
                ...
                br(),
                column(9,offset = 2,
                       p(paste0("Y (Cps_",currentProject()$listeElem[x],"/Cps_Ca) = ", round(currentProject()$regressionModel[x,5],3), " + X (Stand. Rank) * ", round(currentProject()$regressionModel[x,6],3)), style = "font-size:medium;font-weight: bold;")
                ),
                br(),
                barre                                                         
              )
              ...
              output[[tablename]] <- renderUI({
                ...
                if(is.na(tableauStat$temp[x,1])){
                  ...
                  if(tableauStat$temp[x,1] < 0.001){
                    ...
                    valeur1Bis <- format(tableauStat$temp[x,1], scientific = FALSE)
                  }
                }
                ...
                if(is.na(tableauStat$temp[x,2])){
                  ...
                  if(tableauStat$temp[x,2] < 0.001){
                    ...
                    valeur2Bis <- format(tableauStat$temp[x,2], scientific = FALSE)
                  }
                }
                ...
                if(is.na(tableauStat$temp[x,3])){
                  ...
                  if(tableauStat$temp[x,3] < 0.001){
                    ...
                    valeur3Bis <- format(tableauStat$temp[x,3], scientific = FALSE)
                  }
                }
                ...
                if(is.na(tableauStat$temp[x,4])){
                  ...
                  if(tableauStat$temp[x,4] < 0.001){
                    ...
                    valeur4Bis <- format(tableauStat$temp[x,4], scientific = FALSE)
                  }
                }
                ...
                div(
                  div(
                    ...
                    div("Regress.", style ="display: inline-block;width: 70px;text-align: center"),
                    div(val, style ="display: inline-block;width: 70px;text-align: center")
                  ),
                  div(
    ...
    Temp0S <- reactiveValues(t = NULL) # a numerical value which corresponds to the nearest value in the time analysis for the slinderInput of input$binsSample
        ...
        if(is.na(currentProject()$flagMachineCorrection)){        
          ...
          if(currentProject()$flagMachineCorrection == 1){
            ...
            output$sample1 <- renderUI({
              div(class = "class4",
                  div(h3("Step 4. Filtering data from samples"), style = "display: inline-block;")      
              )
            }) # eo output$sample1
                ...
                if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 1){
                  ...
                  output$distPlotSample <- renderPlot({
                    ...
                    if(length(grep(input$SampleIn,currentProject()$samplesFiles)) == 0){                    
                      ...
                      rect(-maxX,-maxY,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$bins,(1+10/100)*maxY, col = "#8B735564", border = NA)                      
                      ...
                      abline(v = currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$bins, lty = "dashed", col = ("grey"), lwd = 2)
          ...
          if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) == 0){            
            ...
            if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 0){
              if(is.null(input$bins)){                
                ...
                if(is.finite(Temp0S$t)){dataPlot2Sample$datS <- currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$getData(curve = input$CourbeSample, bins = Temp0S$t, plat = c(Temp1S$t,Temp2S$t), name = input$SampleIn2, meanStand = currentProject()$standards[[1]]$rep_dataFinale[(nrow(currentProject()$standards[[1]]$rep_dataFinale)-1),], rank = currentProject()$sampleRank, model = currentProject()$regressionModel, calibFile = currentProject()$EtalonData, correction = currentProject()$machineCorrection, rempl = input$valRemplace)
            ...
            if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 1){
              if(is.null(Temp0S$t)){                
                ...
                if(is.finite(Temp0S$t)){dataPlot2Sample$datS <- currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_data[[grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]]$renderData(curve = input$CourbeSample)
          ...
          if(length(grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)) == 0){          
            ...
            if((flagSampleDetail$temp[[grep(input$SampleIn,currentProject()$samplesFiles)]][grep(input$SampleIn2,currentProject()$samples[[grep(input$SampleIn,currentProject()$samplesFiles)]]$rep_Files)]%%2) == 0 & input$saveSample > 0){
              isolate({
                ...
                flagRealign$temp <- currentProject()$flagRealign     
                currentProject()$set_summarySettings(name = input$SampleIn2, rank = NA, bins = NA, plat1 = NA, plat2 = NA, average = NA, LOD = NA)
              })                          
            } else {}
          }
        }
                      ...
                      if(is.list(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster)){
                        if(!is.null(input$elemRaster)){
                          if(length(which(!is.na(unlist(lapply(1:length(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster), function(x){currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataIntermRaster[[x]][,input$elemRaster]}))))) == 0){
                            ...
                            plot(currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataFinalRaster[,1],currentProject()$samples[[grep(input$selectRealign,currentProject()$samplesFiles)]]$rep_dataFinalRaster[,input$elemRaster], xlim = xlim, ylim = ylim, xlab = "", ylab = "", type = "b")
    ...
    output$config0 <- renderUI({
      fluidRow(
        box(
          ...
          width = 12,
          column(9,                       
                 div(h3(icon("cogs"),"Project optional settings"), style = "display: inline-block;")
          )
        )
      )
    }) # eo output$config0
    ...
    output$config1 <- renderUI({
      fluidRow(
        box(
          ...
          column(6, 
                 numericInput("exportwidth", label = "Plot width", value = 480, min = 480)
          ),
          column(6,
                 numericInput("exportheight", label = "Plot height", value = 480, min = 480)
          )
        ),
        box(
          solidHeader = TRUE,
