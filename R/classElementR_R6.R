...
elementR_data <- R6Class("elementR_data",
                         public = list(
                           ...
                           bins = NA, # A numerical value corresponding to the time at which end the blank values
                           ...
                           # Input:  bins = A numerical value corresponding to the time at which end the blank values
                           ##################################################################################################
...
elementR_standard <- R6Class("elementR_standard",
                                ...
                                public = list(                                  
                                  ...
                                  # Input: bins = a numerical value corresponding to the time at which end the blank values, plat = a vector of two numerical values corresponding respectively to the time at which begin and end the plateau
                                  ##################################################################################################
                                  ...
                                  # Input: curve = a character string corresponding to the type of data to render, bins = a numerical value corresponding to the time at which end the blank values, plat = a vector of two numerical values corresponding respectively to the time at which begin and end the plateau
...
elementR_project <- R6Class("elementR_project",
                            public = list(
                              ...
                              set_summarySettings = function(name, rank, bins, plat1, plat2, average, LOD){

                                self$summarySettings[which(rownames(self$summarySettings) == name),] <- c(name, rank, 0, bins, plat1,plat2, average, LOD)
